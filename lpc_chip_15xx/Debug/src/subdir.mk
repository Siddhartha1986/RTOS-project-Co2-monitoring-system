...
src/%.o: ../src/%.c src/subdir.mk
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M3 -D__NEWLIB__ -I"C:\FINALversion\lpc_chip_15xx\inc" -I"C:\FINALversion\FreeRTOS\inc" -I"C:\FINALversion\FreeRTOS\src\include" -I"C:\FINALversion\FreeRTOS\src\portable\GCC\ARM_CM3" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -D__NEWLIB__ -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
